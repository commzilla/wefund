      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-3">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className="border border-slate-700/50 rounded-xl overflow-hidden bg-slate-900/30"
            >
              <button
        ...
        <div className="text-center mt-10">
          <Button 
            variant="outline" 
            className="border-cyan-500/30 text-white hover:bg-cyan-500/10 px-8 py-6 rounded-full"
            asChild
          >
