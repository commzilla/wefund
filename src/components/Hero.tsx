  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20 text-center">
        ...
        {/* Stats Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-[1600px] mx-auto mt-20">
          {/* Community Card */}
          <div className="bg-black/60 backdrop-blur-sm border border-border/40 rounded-2xl pt-4 px-4 pb-2 hover:border-primary/50 transition-all">
            ...
            <div className="relative mb-3">
              ...
              <div className="absolute top-6 left-6">
                <div className="text-5xl font-bold text-foreground mb-1">180+</div>
                <div className="text-base text-muted-foreground">Traders Max Funded</div>
              </div>
            </div>
            ...
            <div className="relative mb-3">
              ...
              <div className="absolute top-1/2 right-6 -translate-y-1/2 text-right">
                <div className="text-5xl font-bold text-foreground mb-1">2,000+</div>
                <div className="text-base text-muted-foreground">Active Traders</div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="absolute top-1/2 left-6 -translate-y-1/2">
                <div className="text-5xl font-bold text-foreground mb-1">128</div>
          ...
          <div className="bg-black/60 backdrop-blur-sm border border-border/40 rounded-2xl pt-4 px-4 pb-2 hover:border-primary/50 transition-all">
            <div className="flex items-center gap-2 text-muted-foreground mb-3 px-1">
              ...
              <span className="text-base font-medium">10X Trader</span>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-3">
                ...
                <div className="relative">
                  ...
                  <div className="absolute bottom-5 left-5">
                    ...
                    <div className="text-base text-muted-foreground">Execution</div>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute bottom-5 left-5">
                    ...
                    <div className="text-base text-muted-foreground">Scaling Plan</div>
                  </div>
                </div>
              </div>
              ...
              <div className="relative flex items-end justify-center pb-6">
                ...
                <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center w-full px-5">
                  <div className="text-3xl font-bold text-foreground mb-1">The Future</div>
                  <div className="text-base text-muted-foreground">of Prop Trading</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-black/60 backdrop-blur-sm border border-border/40 rounded-2xl pt-4 px-4 pb-2 hover:border-primary/50 transition-all">
            <div className="flex items-center gap-2 text-muted-foreground mb-3 px-1">
              ...
              <span className="text-base font-medium">Payouts</span>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="relative">
                ...
                <div className="absolute top-6 left-6">
                  <div className="text-5xl font-bold text-foreground mb-1">500+</div>
                  <div className="text-base text-muted-foreground">Payouts Processed</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="relative">
                  ...
                  <div className="absolute bottom-5 left-5">
                    ...
                    <div className="text-base text-muted-foreground">Highest Payout</div>
                  </div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="absolute bottom-5 left-5">
                    ...
                    <div className="text-base text-muted-foreground">Average Payout</div>
                  </div>
                </div>
              </div>
            </div>
