...
export const Footer = () => {
  return (
    <footer className="relative overflow-hidden bg-[hsl(var(--footer))] pt-12 md:pt-16 pb-6 md:pb-8 px-4 md:px-6">
      {/* Background */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 mb-8 md:mb-12">
          ...
          <div className="lg:col-span-2 flex justify-center lg:justify-end">
            <div className="flex flex-row lg:grid lg:grid-cols-2 gap-2 md:gap-3 h-fit">
              <a
                href="#"
                className="w-9 md:w-10 h-9 md:h-10 bg-slate-800 hover:bg-cyan-500/20 border border-slate-700 hover:border-cyan-500/50 rounded-lg flex items-center justify-center transition-all"
              >
