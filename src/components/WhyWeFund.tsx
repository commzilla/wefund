      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <div className="inline-flex items-center gap-2 px-3 md:px-4 py-1.5 md:py-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 mb-4 md:mb-6">
            <Key className="w-3 md:w-4 h-3 md:h-4 text-cyan-400" />
            <span className="text-cyan-400 text-xs md:text-sm font-medium">Benefits</span>
          </div>
          ...
          {/* Subtitle */}
          <p className="text-muted-foreground text-sm md:text-base max-w-3xl mx-auto leading-relaxed px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-4">
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            {/* Real Scaling Plan */}
            <div className="relative rounded-2xl overflow-hidden border border-cyan-500/20 h-[180px] md:h-[220px]">
              <img 
                src={realScalingBg} 
                alt="" 
              ...
              <div className="absolute bottom-0 left-0 p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold text-white mb-1">Real Scaling Plan</h3>
            ...
            <div className="relative rounded-2xl overflow-hidden border border-cyan-500/20 h-[180px] md:h-[220px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
              <div className="absolute bottom-0 left-0 p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold text-white mb-1">Balance Based Drawdown</h3>
                <p className="text-xs md:text-sm text-muted-foreground">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-cyan-500/20 h-[180px] md:h-[220px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
              <div className="absolute bottom-0 left-0 p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold text-white mb-1">Competitive Spreads</h3>
                <p className="text-xs md:text-sm text-muted-foreground">
          ...
          <div className="flex flex-col gap-3 md:gap-4">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-cyan-500/20 h-[180px] md:h-[220px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
              <div className="absolute bottom-0 left-0 p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold text-white mb-1">Profit Scaling</h3>
                <p className="text-xs md:text-sm text-muted-foreground">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-cyan-500/20 h-[180px] md:h-[220px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
              <div className="absolute bottom-0 left-0 p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold text-white mb-1">No Time Limit</h3>
                <p className="text-xs md:text-sm text-muted-foreground">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-cyan-500/20 h-[180px] md:h-[220px]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent" />
              <div className="absolute bottom-0 left-0 p-4 md:p-6">
                <h3 className="text-lg md:text-xl font-bold text-white mb-1">Fast Payouts</h3>
                <p className="text-xs md:text-sm text-muted-foreground">
          ...
          <div className="flex flex-col gap-3 md:gap-4 sm:col-span-2 lg:col-span-1">
            <div className="grid grid-cols-2 lg:grid-cols-1 gap-3 md:gap-4 lg:h-full lg:flex lg:flex-col">
              {/* Supportive Add-ons */}
              <div className="relative rounded-2xl overflow-hidden border border-cyan-500/20 h-[200px] md:h-[260px] lg:flex-1 lg:min-h-[340px]">
                <img 
                ...
                <div className="absolute bottom-0 left-0 p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-white mb-1">Supportive Add-ons</h3>
                  <p className="text-xs md:text-sm text-muted-foreground">
              ...
              <div className="relative rounded-2xl overflow-hidden border border-cyan-500/20 h-[200px] md:h-[260px] lg:flex-1 lg:min-h-[340px]">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent" />
                <div className="absolute bottom-0 left-0 p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-bold text-white mb-1">Easy to Read Rules</h3>
                  <p className="text-xs md:text-sm text-muted-foreground">
